...
Её использование не обязательно, кроме одного случая, когда вы получаете со стороны сервера готовый html-кусок, то он будет вставлен в блок <b>data-window-section="content"</b>.
